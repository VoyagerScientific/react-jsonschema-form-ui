...
// Components
import { FIELD_MAP, READONLY_SCHEMA } from '../constants';
...
xdescribe('fields/RawHTMLField', () => {
  it('should state be immutable when readonly property is true', () => {
    ...
    const props = {
      ...
      uiSchema: UI_SCHEMA.raw_html,
      readonly: true,
      onChange: onChangeFake,
    };
    const widget = TestRenderer.create(<RawHTMLField {...props} />);
    ...
    widget.getInstance().should.be.instanceOf(RawHTMLField);
